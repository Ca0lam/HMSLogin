...
namespace HMSLogin.Database
{
	...
	public partial class HospitalMSDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeletetblBedDetail(tblBedDetail instance);
		...
		public HospitalMSDataContext() : 
				base(global::HMSLogin.Properties.Settings.Default.HospitalMSConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public HospitalMSDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public HospitalMSDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public HospitalMSDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public HospitalMSDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnDeptIdChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_DocPhoto", DbType="Image", UpdateCheck=UpdateCheck.Never)]
